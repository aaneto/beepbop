...
impl Bot {
    ...
    pub fn get_updates(self, input_data: GetUpdateArgs) -> impl Future<Item = (Self, Vec<Update>), Error = APIError> {
        TelegramRequest {
            method: Method::POST,
    ...
    pub fn send_message(self, input_data: SendMessage) -> impl Future<Item = (Self, Message), Error = APIError> {
        TelegramRequest {
            method: Method::GET,
    ...
    pub fn set_chat_title<ID>(self, id: ID, title: String) -> impl Future<Item = (Self, bool), Error = APIError>
    where ID: Into<ChatID>
    {
    ...
    pub fn set_chat_description<ID>(self, id: ID, description: String) -> impl Future<Item = (Self, bool), Error = APIError>
    where ID: Into<ChatID>
    {
    ...
    pub fn pin_message<ID>(self, id: ID, message_id: i64, disable_notification: bool) -> impl Future<Item = (Self, bool), Error = APIError>
    where ID: Into<ChatID>
    {
    ...
    pub fn get_chat_members_count<ID>(self, id: ID) -> impl Future<Item = (Self, u64), Error = APIError>
    where ID: Into<ChatID>
    {
        TelegramRequest {
            method: Method::GET,
    ...
    pub fn send_location(self, send_location: SendLocation) -> impl Future<Item = (Self, Message), Error = APIError>
    {
        TelegramRequest {
            method: Method::GET,
    ...
    pub fn get_file(self, file_id: String) -> impl Future<Item = (Self, FileInfo), Error = APIError>
    {
        TelegramRequest {
            method: Method::GET,
    ...
    pub fn send_contact(self, send_contact: SendContact) -> impl Future<Item = (Self, Message), Error = APIError>
    {
        TelegramRequest {
            method: Method::GET,
